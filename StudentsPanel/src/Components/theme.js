  ...
  components: {
    Table: {
      variants: {
        striped: (props) => ({
          // th: {
          //   bg: props.colorMode === 'light' ? colors.lightMode.tableHeadingBg : colors.darkMode.secondaryBg,
          //   color: props.colorMode === 'light' ? colors.lightMode.tableHeadingTxt : colors.darkMode.tableHeadingTxt,
          // },
          tbody: {
            tr: {
              '&:nth-of-type(odd)': {
